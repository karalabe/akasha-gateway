...
func NewProfileResolver(address common.Address, backend bind.ContractBackend) (*ProfileResolver, error) {
	contract, err := bindProfileResolver(address, backend, backend)
	if err != nil {
		return nil, err
	}
	return &ProfileResolver{ProfileResolverCaller: ProfileResolverCaller{contract: contract}, ProfileResolverTransactor: ProfileResolverTransactor{contract: contract}}, nil
}
...
func NewProfileResolverCaller(address common.Address, caller bind.ContractCaller) (*ProfileResolverCaller, error) {
	contract, err := bindProfileResolver(address, caller, nil)
	if err != nil {
		return nil, err
	}
...
func NewProfileResolverTransactor(address common.Address, transactor bind.ContractTransactor) (*ProfileResolverTransactor, error) {
	contract, err := bindProfileResolver(address, nil, transactor)
	if err != nil {
		return nil, err
	}
...
func bindProfileResolver(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor) (*bind.BoundContract, error) {
